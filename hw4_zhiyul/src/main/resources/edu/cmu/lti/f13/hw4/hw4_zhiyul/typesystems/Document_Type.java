...
/* First created by JCasGen Fri Oct 25 14:53:34 EDT 2013 */
...
/** 
 * Updated by JCasGen Fri Oct 25 15:21:09 EDT 2013
 * @generated */
public class Document_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.f13.hw4.hw4_zhiyul.typesystems.Document");
  ...
  public int getRelevanceValue(int addr) {
      ...
      jcas.throwFeatMissing("relevanceValue", "edu.cmu.lti.f13.hw4.hw4_zhiyul.typesystems.Document");
  ...
  public int getQueryID(int addr) {
      ...
      jcas.throwFeatMissing("queryID", "edu.cmu.lti.f13.hw4.hw4_zhiyul.typesystems.Document");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "edu.cmu.lti.f13.hw4.hw4_zhiyul.typesystems.Document");
  ...
  public int getTokenList(int addr) {
      ...
      jcas.throwFeatMissing("tokenList", "edu.cmu.lti.f13.hw4.hw4_zhiyul.typesystems.Document");
